table 74290 "AYBK Booking Header"
{
    Caption = 'Booking Header';
    DataClassification = ToBeClassified;
    LookupPageId = "AYBK Booking List";
    DrillDownPageId = "AYBK Booking List";
    ...
    fields
    {
        ...
        field(1000; "Booking Start Date"; Date)
        {
            ...
            CalcFormula = min("AYBK Booking Line".Date where("Booking No." = field("No.")));
            Editable = false;
        }
        field(1001; "Booking End Date"; Date)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = max("AYBK Booking Line".Date where("Booking No." = field("No.")));
            Editable = false;
        }
    }
    keys
