table 74292 "AYBK Booking Arch. Header"
{
    Caption = 'Archive Booking Header';
    DataClassification = ToBeClassified;
    LookupPageId = "AYBK Booking Arch. List";
    DrillDownPageId = "AYBK Booking Arch. List";
    ...
    fields
    {
        ...
        field(1000; "Booking Start Date"; Date)
        {
            ...
            CalcFormula = min("AYBK Booking Arch. Line".Date where("Booking No." = field("No.")));
            Editable = false;
        }
        field(1001; "Booking End Date"; Date)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = max("AYBK Booking Arch. Line".Date where("Booking No." = field("No.")));
            Editable = false;
        }
    }
    keys
