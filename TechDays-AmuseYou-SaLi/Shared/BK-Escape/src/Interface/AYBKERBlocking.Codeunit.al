codeunit 74421 "AYBKER Blocking"
{
    [EventSubscriber(ObjectType::Table, Database::"AYER Escape Room", 'OnAfterBlocked', '', false, false)]
    local procedure WarnIfPendingBookings(Rec: Record "AYER Escape Room")
    var
